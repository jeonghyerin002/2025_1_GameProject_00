...
public class FruitGame : MonoBehaviour
{
    ...
    public void CheckGameOver()
    {
        ...
        float gameOverHieght = gameHieght;
        ...
        for(int i = 0; i < allFruits.Length; i++)
        {
            ...
            if (rb != null && rb.velocity.magnitude < 0.1f && allFruits[i].transform.position.y > gameOverHieght)
            ...
            Debug.Log(allFruits[i].transform.position.y);
        }
    }
}
